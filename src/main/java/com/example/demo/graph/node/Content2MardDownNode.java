...
@Slf4j
public class Content2MardDownNode implements NodeAction {

    private ChatModel chatModel;

    private List<ToolCallback> tools;

    public static Content2MardDownNode.Builder builder() {
        return new Builder();
    }
    ...
    public static class Builder {
        ...
        public Content2MardDownNode build() {
            return new Content2MardDownNode(this);
        }
    }

    public Content2MardDownNode(Builder builder) {
...
/*    String SKILLS_MD_PROMPT = """
    ...
    public Map<String, Object> apply(OverAllState state) throws GraphRunnerException {
        ...
        String userPrompt = state.value("userPrompt")
                .map(v -> (String) v)
                .orElse("");
...
//                .systemPrompt("You are a helpful assistant")
                ...
                .build();
        AssistantMessage call = agent.call(userPrompt);
        ...
        log.info("用户输入转md完成: {}", call.getText());
        return Map.of(
                "tool_result", result
        );
    }
